...
class Config():
    def __init__(self, input_args):
        ...
        self.HYPER_MODEL_MAP = {
            ...
            'MTL_HPS': self.__MTL_HPS,
            'MTL_PS_MCNN': self.__MTL_PS_MCNN,
            'MTL_MRN': self.__MTL_MRN,
            'MTL_CSN': self.__MTL_CSN,
            'MTL_NDDR': self.__MTL_NDDR,
            'MTAN': self.__MTAN,
            'OUR': self.__Our,
        }
    ...
    def __MTL_MRN(self):
        tmp = {
            ...
            'datasetParas':{
                'RAF':{
                    'batch_size': 64,
                    'sharedEmbeddingSize': 2000,
                    'com_embedding': 256,
                    'weight_decay': 5e-3,
                    'weight_centerLoss': 0.1,
                    'weight_fer': 0.5,
                    'weight_lm': 0.2,
                    'weight_mtk': 0.1,
                    'learning_rate': 0.01,
...
class ConfigDebug():
    def __init__(self, input_args):
        ...
        self.HYPER_MODEL_MAP = {
            ...
            'MTL_CSN': self.__MTL_CSN,
            'OUR': self.__OUR,
            # 'ATT_FER_DCNN': self.__ATT_FER_DCNN,
        }
        # hyper parameters for datasets
        self.HYPER_DATASET_MAP = self.__datasetCommonParams()
    ...
    def __MTL_HPS(self):
        tmp = {
            ...
            'datasetParas':{
                'RAF':{
                    # ref Original Paper
                    'd_paras': ['batch_size', 'fer_embedding', 'lm_embedding', 'weight_decay', \
                                'weight_lm', 'lr'],
                    'batch_size': random.choice([64,32]),
                    'fer_embedding': random.choice([128, 256]),
                    'lm_embedding': random.choice([1024, 2048]),
                    'weight_decay': random.choice([0.005, 0.0]),
                    'weight_lm': random.choice([0.2, 0.5, 1.0]),
                    'lr': random.choice([0.01]),
                },
                'CK+':{
                    # ref Original Paper
    ...
    def __MTL_MRN(self):
        tmp = {
            ...
            'datasetParas':{
                'RAF':{
                    'd_paras': ['batch_size', 'sharedEmbeddingSize', 'com_embedding', 'weight_decay', \
                                'weight_centerLoss', 'weight_fer', 'weight_lm', 'weight_mtk', \
                                'learning_rate', 'centerlossLR'],
                    'batch_size': random.choice([64,32]),
                    'sharedEmbeddingSize': random.choice([1024]),
                    'com_embedding': random.choice([256]),
                    'weight_decay': random.choice([0.05,0.01,0.005]),
                    'weight_centerLoss': random.choice([0.1,0.05,0.01,0.005]),
                    'weight_fer': random.choice([0.2]),
                    'weight_lm': random.choice([0.2]),
                    'weight_mtk': random.choice([0.2]),
                    'learning_rate': random.choice([0.01]),
                    'centerlossLR': random.choice([0.1, 0.01, 0.001]),
                },
           },
        }
        return tmp
    ...
    def __MTL_CSN(self):
        tmp = {
            ...
            'datasetParas':{
                'RAF':{
                    'd_paras': ['batch_size', 'fer_embedding', 'lm_embedding', 'weight_decay', 'weight_lm', 'lr'],
                    'batch_size': random.choice([64,32]),
                    'fer_embedding': random.choice([128, 256]),
                    'lm_embedding': random.choice([1024, 2048]),
                    'weight_decay': random.choice([0.005, 0.0]),
